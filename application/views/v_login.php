  ...
  <div class="login-box">
    ...
    if(isset($_GET['alert'])){
        if($_GET['alert']=="gagal"){
          ...
          echo "<div class='alert alert-success font-weight-bold text-center'>Registrasi Akun berhasil, Silahkan Login</div>";
      }
    } 
    ?>
        ...
        <div class="row">
          <div class="col-xs-8">
            <div class="checkbox icheck">
              <label>
                 <a href="<?php echo base_url('registrasi'); ?>">Daftarkan Akun Sebagai Penulis</a>
              </label>
            </div>
          </div>
          <!-- /.col -->
