...
<section class="paralax-mf footer-paralax bg-image sect-mt4 route" style="background-image: url(<?php echo base_url();?>assets_frontend/img/footer-bg.jpg)">
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="copyright-box">
            ...
            <p class="copyright">&copy; Copyright 2022 <strong><?php echo $pengaturan->nama ?></strong>
          </div>
        </div>
      </div>
    </div>
